...
class ColorPreference(context: Context, attrs: AttributeSet): ListPreference
    ...
    override fun onClick() {
        ...
        // кружочке галку.
        val dialogFragment: DialogFragment = ColorDialogFragment.newInstance(Bundle().apply {
            putString(ColorDialogFragment.EXTRA_TITLE_KEY, title.toString())
            putCharSequenceArray(ColorDialogFragment.EXTRA_ENTRIES_KEY, entries)
            putCharSequenceArray(ColorDialogFragment.EXTRA_VALUES_KEY, entryValues)
